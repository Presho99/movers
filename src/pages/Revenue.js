...
function Revenue() {
  const [transactions] = useState([
    { id: 1, customer: 'John Doe', amount: 5000, status: 'Paid', date: '2024-11-15' },
    { id: 2, customer: 'Jane Smith', amount: 3000, status: 'Pending', date: '2024-11-16' },
    { id: 3, customer: 'Bob Lee', amount: 7000, status: 'Failed', date: '2024-11-17' },
  ]);
